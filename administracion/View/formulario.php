  ...
  <body style="background-color:#e6ffe6;">
    ...
    <div id="container">
      ...
      <div id="content">
		  ...
		  <form id="formulario_alta" action="../Controller/insertar.php" enctype="multipart/form-data" method="post">
          <table class="table table-striped">
            ...
            <tr>
				<td>Fecha_Publicacion<input type="datetime-local" name="fecha"  size="19"></td></tr>
			<tr>
